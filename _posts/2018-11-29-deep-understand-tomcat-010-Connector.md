...
![Connector整体结构图](https://upload-images.jianshu.io/upload_images/845143-3b14ae6c1d58ebbf.png?jianshufrom=true)

【注意】：不同的协议、不同的通信方式，`ProtocolHandler`会有不同的实现。在Tomcat8.5中，`ProtocolHandler`的类继承层级如下图所示。

![ProtocolHandler类继承层级](https://upload-images.jianshu.io/upload_images/845143-8e10276901d6b803.png?jianshufrom=true)
...
![调用链路图](https://upload-images.jianshu.io/upload_images/845143-0531aaf3bb0b333f.png?jianshufrom=true)
